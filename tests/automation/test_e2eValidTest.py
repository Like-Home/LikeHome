...
class TestE2eValidTest():
  ...
  def test_e2eValidTest(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".JDAKTe:nth-child(2) .w1I7fb").click()
    self.driver.find_element(By.CSS_SELECTOR, ".css-vubbuv").click()
    self.driver.find_element(By.CSS_SELECTOR, ".css-pelz90:nth-child(1)").click()
    self.driver.find_element(By.ID, ":r2:").send_keys("San Jose - Silicon Valley - CA")
    self.driver.find_element(By.NAME, "date").click()
    self.driver.find_element(By.CSS_SELECTOR, ".css-jbxpc8").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".card:nth-child(1) > .MuiButtonBase-root > .MuiStack-root > .MuiStack-root")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".card:nth-child(2) > .MuiButtonBase-root > .MuiStack-root > .MuiStack-root > .MuiStack-root:nth-child(1) > .MuiTypography-root").click()
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".MuiGrid2-root:nth-child(2) .MuiButtonBase-root").click()
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").send_keys("Noah")
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").send_keys("N")
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").send_keys("asdfg@gmail.com")
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".Mui-focused > .MuiInputBase-input").send_keys("123456789")
