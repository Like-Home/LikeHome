...
# amadeus client id and secret added 
AMADEUS_CLIENT_ID = getenv('AMADEUS_CLIENT_ID', required=PRODUCTION)
AMADEUS_CLIENT_SECRET = getenv('AMADEUS_CLIENT_SECRET', required=PRODUCTION